 ...
 * 2020-01-27T16:36:02.250+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "TSTransferWebService",
                  wsdlLocation = "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/TSTransferWebService_Updated.WSDL",
...
public class TSTransferWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/TSTransferWebService_Updated.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TSTransferWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/TSTransferWebService_Updated.WSDL");
        }
        WSDL_LOCATION = url;
    }
