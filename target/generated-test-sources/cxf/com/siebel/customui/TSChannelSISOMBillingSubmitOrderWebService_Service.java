 ...
 * 2020-01-24T13:42:52.246+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "TSChannelSISOMBillingSubmitOrderWebService",
                  wsdlLocation = "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/TSChannelSISOMBillingSubmitOrderWebService_v2.2.WSDL",
...
public class TSChannelSISOMBillingSubmitOrderWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/TSChannelSISOMBillingSubmitOrderWebService_v2.2.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TSChannelSISOMBillingSubmitOrderWebService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/TSChannelSISOMBillingSubmitOrderWebService_v2.2.WSDL");
        }
        WSDL_LOCATION = url;
    }
