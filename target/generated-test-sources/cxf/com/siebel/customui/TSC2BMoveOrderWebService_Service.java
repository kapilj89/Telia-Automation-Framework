 ...
 * 2020-01-24T13:42:51.531+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "TSC2BMoveOrderWebService",
                  wsdlLocation = "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/TSC2BMoveOrderWebService.WSDL",
...
public class TSC2BMoveOrderWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/TSC2BMoveOrderWebService.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TSC2BMoveOrderWebService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/TSC2BMoveOrderWebService.WSDL");
        }
        WSDL_LOCATION = url;
    }
