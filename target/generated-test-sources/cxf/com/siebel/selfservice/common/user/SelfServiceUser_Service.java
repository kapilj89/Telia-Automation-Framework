 ...
 * 2020-01-24T13:42:51.264+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "SelfServiceUser",
                  wsdlLocation = "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/SelfServiceUser_v1.4.WSDL",
...
public class SelfServiceUser_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/SelfServiceUser_v1.4.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SelfServiceUser_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/SelfServiceUser_v1.4.WSDL");
        }
        WSDL_LOCATION = url;
    }
