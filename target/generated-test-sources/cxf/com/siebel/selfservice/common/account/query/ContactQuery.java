 ...
 *         &lt;element name="TSLastUpdEmail" type="{http://www.siebel.com/SelfService/Common/Account/Query}queryType" minOccurs="0"/&gt;
 *         &lt;element name="TSLastUpdFixed" type="{http://www.siebel.com/SelfService/Common/Account/Query}queryType" minOccurs="0"/&gt;
 *         &lt;element name="TSLastUpdMobile" type="{http://www.siebel.com/SelfService/Common/Account/Query}queryType" minOccurs="0"/&gt;
 *         &lt;element name="Temporary" type="{http://www.siebel.com/SelfService/Common/Account/Query}queryType" minOccurs="0"/&gt;
...
public class ContactQuery {
    ...
    protected QueryType tsLastUpdEmail;
    @XmlElement(name = "TSLastUpdFixed")
    protected QueryType tsLastUpdFixed;
    @XmlElement(name = "TSLastUpdMobile")
    protected QueryType tsLastUpdMobile;
    @XmlElement(name = "Temporary")
    protected QueryType temporary;
     ...
     *     
     */
    public QueryType getTSLastUpdEmail() {
     ...
     *     
     */
    public void setTSLastUpdEmail(QueryType value) {
     ...
     *     
     */
    public QueryType getTSLastUpdFixed() {
     ...
     *     
     */
    public void setTSLastUpdFixed(QueryType value) {
     ...
     *     
     */
    public QueryType getTSLastUpdMobile() {
     ...
     *     
     */
    public void setTSLastUpdMobile(QueryType value) {
     ...
     *     
     */
    public void setTemporary(QueryType value) {
