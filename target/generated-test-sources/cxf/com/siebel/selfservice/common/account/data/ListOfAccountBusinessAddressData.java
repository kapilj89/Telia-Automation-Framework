...
/**
 * <p>Java class for ListOfAccountBusinessAddressData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfAccountBusinessAddressData"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="AccountBusinessAddress" type="{http://www.siebel.com/SelfService/Common/Account/Data}AccountBusinessAddressData" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ListOfAccountBusinessAddressData", propOrder = {
    "accountBusinessAddress"
})
public class ListOfAccountBusinessAddressData {

    @XmlElement(name = "AccountBusinessAddress")
    protected List<AccountBusinessAddressData> accountBusinessAddress;
     ...
     * {@link AccountBusinessAddressData }
     * 
     * 
     */
    public List<AccountBusinessAddressData> getAccountBusinessAddress() {
        if (accountBusinessAddress == null) {
            accountBusinessAddress = new ArrayList<AccountBusinessAddressData>();
        }
