...
/**
 * <p>Java class for ListOfUDSPublishCatalogData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfUDSPublishCatalogData"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Catalog" type="{http://siebel.com/OrderManagement/Catalog/Data/UDSPublishCatalog/Data}CatalogData" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ListOfUDSPublishCatalogData", propOrder = {
    "catalog"
})
public class ListOfUDSPublishCatalogData {

    @XmlElement(name = "Catalog")
    protected List<CatalogData> catalog;
    ...
    public List<CatalogData> getCatalog() {
        if (catalog == null) {
            catalog = new ArrayList<CatalogData>();
        }
        return this.catalog;
    }
