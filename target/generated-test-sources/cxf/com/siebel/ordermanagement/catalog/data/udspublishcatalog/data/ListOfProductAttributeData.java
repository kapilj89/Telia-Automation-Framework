...
/**
 * <p>Java class for ListOfProductAttributeData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfProductAttributeData"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="ProductAttribute" type="{http://siebel.com/OrderManagement/Catalog/Data/UDSPublishCatalog/Data}ProductAttributeData" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ListOfProductAttributeData", propOrder = {
    "productAttribute"
})
public class ListOfProductAttributeData {

    @XmlElement(name = "ProductAttribute")
    protected List<ProductAttributeData> productAttribute;
     ...
     * {@link ProductAttributeData }
     * 
     * 
     */
    public List<ProductAttributeData> getProductAttribute() {
        if (productAttribute == null) {
            productAttribute = new ArrayList<ProductAttributeData>();
        }
