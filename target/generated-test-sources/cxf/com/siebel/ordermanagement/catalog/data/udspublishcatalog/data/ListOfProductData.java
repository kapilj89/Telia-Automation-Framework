...
/**
 * <p>Java class for ListOfProductData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ListOfProductData"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="Product" type="{http://siebel.com/OrderManagement/Catalog/Data/UDSPublishCatalog/Data}ProductData" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ListOfProductData", propOrder = {
    "product"
})
public class ListOfProductData {
    ...
    public List<ProductData> getProduct() {
        if (product == null) {
            product = new ArrayList<ProductData>();
        }
        return this.product;
    }
