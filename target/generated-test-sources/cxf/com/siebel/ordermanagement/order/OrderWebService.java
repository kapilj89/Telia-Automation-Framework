 ...
 * 2020-01-27T16:35:58.238+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "OrderWebService",
                  wsdlLocation = "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/OrderWebService_v2.7.WSDL",
...
public class OrderWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/OrderWebService_v2.7.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(OrderWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/OrderWebService_v2.7.WSDL");
        }
        WSDL_LOCATION = url;
    }
