 ...
 * 2020-01-27T15:39:16.153+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ProductConfigurator",
                  wsdlLocation = "file:/C:/Siebel_20.1/fixed-testframework/siebel-api-test/src/test/resources/wsdlfiles/ProductConfigurator.WSDL",
...
public class ProductConfigurator extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Siebel_20.1/fixed-testframework/siebel-api-test/src/test/resources/wsdlfiles/ProductConfigurator.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProductConfigurator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Siebel_20.1/fixed-testframework/siebel-api-test/src/test/resources/wsdlfiles/ProductConfigurator.WSDL");
        }
        WSDL_LOCATION = url;
    }
