 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PropertyType" type="{http://siebel.com/OrderManagement/Configurator/CfgProperties}PropertyType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Properties {
    ...
    protected List<PropertyType> propertyType;
    ...
    public List<PropertyType> getPropertyType() {
        if (propertyType == null) {
            propertyType = new ArrayList<PropertyType>();
        }
