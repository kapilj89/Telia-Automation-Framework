 ...
 * 2020-01-27T16:36:00.206+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "QuoteWebService",
                  wsdlLocation = "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/QuoteWebService.WSDL",
...
public class QuoteWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/QuoteWebService.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(QuoteWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/QuoteWebService.WSDL");
        }
        WSDL_LOCATION = url;
    }
