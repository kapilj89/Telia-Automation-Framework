 ...
 * 2020-01-27T16:35:59.859+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "QuoteCheckOutWebService",
                  wsdlLocation = "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/QuoteCheckOutWebService.WSDL",
...
public class QuoteCheckOutWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/QuoteCheckOutWebService.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(QuoteCheckOutWebService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Siebel_20.1/telia-automation-framework/siebel-api-test/src/test/resources/wsdlfiles/QuoteCheckOutWebService.WSDL");
        }
        WSDL_LOCATION = url;
    }
