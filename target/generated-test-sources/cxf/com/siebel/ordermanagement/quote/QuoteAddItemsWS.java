 ...
 * 2020-01-24T13:42:48.737+05:30
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "QuoteAddItemsWS",
                  wsdlLocation = "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/QuoteAddItemsWS.WSDL",
...
public class QuoteAddItemsWS extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/QuoteAddItemsWS.WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(QuoteAddItemsWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/siebel_encrypt/siebel-api-test/src/test/resources/wsdlfiles/QuoteAddItemsWS.WSDL");
        }
        WSDL_LOCATION = url;
    }
