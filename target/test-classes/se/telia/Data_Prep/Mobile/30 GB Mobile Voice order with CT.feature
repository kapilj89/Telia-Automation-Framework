...
Feature: Create Base orders - 3No's  
  ...
  Scenario Outline: Create Mobile Voice order with unlimited promotion with CT
   ...
   Examples: 
     | TestcaseName                       |
     | 30 GB Mobile Voice order with CT-1 |
#		 | 30 GB Mobile Voice order with CT-2 |
#		 | 30 GB Mobile Voice order with CT-3 |
     #| 30 GB Mobile Voice order with CT-4 |
     #| 30 GB Mobile Voice order with CT-5 |
