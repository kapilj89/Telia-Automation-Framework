...
Feature: Create Base order  
  ...
  Scenario Outline: Create Mobile Voice order with 30 GB promotion and add voice supplementary line
    ...
    Examples:
      | TestcaseName																					 |
      | 30 GB Mobile Voice order with voice supplementary line |
