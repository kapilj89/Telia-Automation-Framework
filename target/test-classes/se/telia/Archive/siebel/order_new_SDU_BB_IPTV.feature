Feature: IPTV on LAN SDU access, with hardware (router + TV-box)

  @SDUrouter+TV-box
  Scenario: Create New IPTV on LAN SDU access, with hardware (router + TV-box)
    This scenario used create new IPTV on LAN SDU access, with hardware (router + TV-box)
