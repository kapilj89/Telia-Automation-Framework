@DP_MDU_BBVOIP
Feature:  Test for New MDU BroadBand VOIP order

  Scenario Outline: Create New MDU BroadBand VOIP order
  This scenario used create new MDU BroadBand VOIP order 
    ...
    And call EndConfigurationService and get Quote
    And call BBVOIP SynchronizeQuote to populate the deliveryContract "Agreement" Revision "RevisionNumber" RowID "RowID" and AccessCode "AccessType" on the quote line items for a MDU order
    And call QuoteCheckOutService and get ActiveOrderID
    And call TSChannelSubmitOrder to submit the order

    Examples: 
      | TestcaseName                              |
      | MDU_DATA_PREP_B2B_MDU_New_Broadband_VoIP1 |
      | MDU_DATA_PREP_B2B_MDU_New_Broadband_VoIP2 |
      | MDU_DATA_PREP_B2B_MDU_New_Broadband_VoIP3 |
      | MDU_DATA_PREP_B2B_MDU_New_Broadband_VoIP4 |
      | MDU_DATA_PREP_B2B_MDU_New_Broadband_VoIP5 |
      | MDU_B2B_New_Broadband_VoIP                |
